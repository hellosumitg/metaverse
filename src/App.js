...
function App() {
	...
	const loadBlockchainData = async () => {
		...
		if (typeof window.ethereum !== 'undefined') {
			...
			// Event listener for blockchain or chain change...
	...
	// below fuctions will be get triggered whenever anybody clicks on buy Property and this will handle all the buying of this virtual land.
	...
	return (
		<div>
			...
			{/* Now for putting all of our virtual land we use... */}
